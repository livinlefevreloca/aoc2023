...
use days::{
    day1::Day1, day10::Day10, day11::Day11, day12::Day12, day13::Day13, day14::Day14, day15::Day15, day16::Day16, day2::Day2, day3::Day3, day4::Day4,
...
fn main() {
    ...
    match problem.as_deref() {
        ...
        Some("16") => {
            Day16::problem1(&file).unwrap();
            Day16::problem2(&file).unwrap();
        }
